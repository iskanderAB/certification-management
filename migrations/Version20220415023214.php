...
final class Version20220415023214 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE work_certificate (id INT AUTO_INCREMENT NOT NULL, worker_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, created_at DATE NOT NULL, chef VARCHAR(255) NOT NULL, signer VARCHAR(255) NOT NULL, INDEX IDX_3E5D3A896B20BA36 (worker_id), INDEX IDX_3E5D3A89B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE worker (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) NOT NULL, cin INT DEFAULT NULL, ref VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT NULL, gender VARCHAR(1) NOT NULL, poste VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_9FB2BF62146F3EA3 (ref), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
